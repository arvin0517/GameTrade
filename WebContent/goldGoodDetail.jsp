...
<input type="hidden" name="" id="hid_buyName" value="<s:property value="gguser.uname" />" />
			<div id="first">
	  		<div id="first_one">
	  		  <div id="first_one_ldiv">
	  			<ul id="first_one_l">
                   ...
                   <li><a href="manFormAction_manFormTest.action"></a></li>
	  			</ul>
	  			<ul id="first_one_r">
	  	  ...
	  	  <div id="sh_second">
	  	  	 <span>您的位置：<a href="mainFrmae.jsp">首页</a>><a href="buyGame.jsp">全部游戏</a>><a href="buyGoodsAction_findGoodsByTid.action?typeId=<s:property value="ggtype.tid" />"><s:property value="ggtype.typename" /></a>>商品详情</span>
	  	  </div>
	  	  <div id="gd_third"></div>
	  	  <div id="gd_fourth">
	  	  	 <h5>商品详情</h5>
	  	  ...
	  	  <div id="gd_fifth">
	  	  	 <span>商品名称:&nbsp;
	  	  	     <s:if test="gguser.credit <= 10 ">【一星卖家】</s:if>
	  	 	     <s:elseif test="gguser.credit <= 20">【二星卖家】</s:elseif>
	  	 	     <s:elseif test="gguser.credit <= 30">【三星卖家】</s:elseif>
	  	 	     <s:elseif test="gguser.credit <= 40">【四星卖家】</s:elseif>
	  	 	     <s:elseif test="gguser.credit < 50">【四星卖家】</s:elseif>
	  	 	     <s:elseif test="gguser.credit >= 50">【五星卖家】</s:elseif>
	  	  	    <s:property value="gname" />
	  	  	 </span>
	  	  </div>
	  	  <div id="gd_sixth">
	  	  	 <img src="img/gametype/gametype<s:property value="ggtype.tid" />.jpg" alt="" />
	  	  	 <div class="">
	  	  	 	<ul class="sixth_ul1">
	  	  	 		<li>商品售价：</li>
	  	  	 		<li>商品库存：</li>
	  	  	 	...
	  	  	 	<ul class="sixth_ul2">
	  	  	 		<li><h2><s:property value="gprice" /></h2>元</li>
	  	  	 		<li><s:property value="savenum" />件</li>
	  	  	 		<li><s:property value="ggtype.typename" /></li>
	  	  	 		<li><s:property value="goodType" /></li>
	  	  	 		<li><s:property value="gguser.uname" /></li>
	  	  	 		<li>
	  	  	 		      <s:if test="gguser.credit <= 10 "><div style="width: 17px;"></div></s:if>
	  	  	 	          <s:elseif test="gguser.credit <= 20"><div style="width: 34px;"></div></s:elseif>
	  	  	 	          <s:elseif test="gguser.credit <= 30"><div style="width: 50px;"></div></s:elseif>
	  	  	 	          <s:elseif test="gguser.credit <= 40"><div style="width: 67px;"></div></s:elseif>
	  	  	 	          <s:elseif test="gguser.credit < 50"><div style="width: 67px;"></div></s:elseif>
	  	  	 	          <s:elseif test="gguser.credit >= 50"><div style="width: 84px;"></div></s:elseif>
	  	  	 		</li>      <!--这里面的‘div’是为了控制星星的个数-->
	  	  	 	</ul>
	  	  	 	<a id="buy_bt" href="manFormAction_getGoodByGid.action?goodId=<s:property value="gid" />">立即购买</a>
	  	  	 </div>
	  	  </div>
	  	  <div id="gd_seventh">
	  	  	 <span>账号描叙</span>
